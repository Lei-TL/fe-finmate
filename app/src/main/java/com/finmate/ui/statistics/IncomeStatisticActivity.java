...
public class IncomeStatisticActivity extends AppCompatActivity {
            ...
            btnTimeFilter.setOnClickListener(v -> {
                ...
                bottomSheet.setListener(new com.finmate.ui.dialogs.TimeFilterBottomSheet.TimeFilterListener() {
                    ...
                    public void onTodaySelected() {
                        ...
                        com.finmate.core.ui.TimeFilterManager.saveTimeFilter(IncomeStatisticActivity.this, startDateFilter, endDateFilter, filterText);
                    ...
                    public void onClear() {
                        ...
                        com.finmate.core.ui.TimeFilterManager.clearTimeFilter(IncomeStatisticActivity.this);
    ...
    private void processTransactions(List<TransactionEntity> transactions) {
        ...
        if (tvTotalIncome != null) {
            tvTotalIncome.setText("+" + formatAmount(totalIncome) + " VND");
        }
        
        // Load charts
        loadBarChartData(incomeTransactions);
        loadPieChartData(incomeTransactions);
    }
    ...
    private void loadBarChartData(List<TransactionEntity> transactions) {
        ...
        Legend legend = barChartIncome.getLegend();
        ...
        com.github.mikephil.charting.components.YAxis yAxisLeft = barChartIncome.getAxisLeft();
        ...
        com.github.mikephil.charting.components.YAxis yAxisRight = barChartIncome.getAxisRight();
        yAxisRight.setEnabled(false); // Tắt YAxis bên phải

        // ✅ Chart animation phải chạy trên main thread
        runOnUiThread(() -> {
            barChartIncome.animateY(800);
            barChartIncome.invalidate();
        });
    }
    ...
    private void highlightTabs() {
        ...
        tvIncomeTab.setTextColor(textColorPrimary);
        ...
        tvExpenseTab.setTextColor(textColorSecondary);
